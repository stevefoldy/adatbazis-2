<div class="h6">Melyik gazda mennyit költött átlagosan?</div>
<?php

include_once 'connection.php';

$query = 'SELECT nev, AVG(kezeles.dij) AS `atlag` FROM kezeles INNER JOIN kutya ON kutya.id = kezeles.kutyaId INNER JOIN gazda ON gazda.id = kutya.gazdaId GROUP BY nev ORDER BY `atlag` DESC';
